...
@LinkURI("https://exanple.org/ome-nbo/NBOFilamentLightSource")
public class NBOFilamentLightSource extends FilamentLightSource {
    ...
    public String toString() {
        return "NBOFilamentLightSource(id=" + this.getId() + ")";
    }

    @Override
    public boolean equals(final Object o) {
        if ( o == this ) return true;
        if ( !(o instanceof NBOFilamentLightSource) ) return false;
        final NBOFilamentLightSource other = (NBOFilamentLightSource) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof NBOFilamentLightSource;
    }
