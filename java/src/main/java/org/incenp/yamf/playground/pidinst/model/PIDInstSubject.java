...
@LinkURI("https://example.invalid/pidinst/PIDInstSubject")
public class PIDInstSubject {
    ...
    public boolean equals(final Object o) {
        ...
        if ( !(o instanceof PIDInstSubject) ) return false;
        final PIDInstSubject other = (PIDInstSubject) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof PIDInstSubject;
    }
