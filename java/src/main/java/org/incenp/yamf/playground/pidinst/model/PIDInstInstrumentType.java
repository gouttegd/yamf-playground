...
@LinkURI("https://example.invalid/pidinst/PIDInstInstrumentType")
public class PIDInstInstrumentType {
    ...
    public String toString() {
        ...
        Object o;
        sb.append("PIDInstInstrumentType(");
    ...
    public boolean equals(final Object o) {
        ...
        if ( !(o instanceof PIDInstInstrumentType) ) return false;
        final PIDInstInstrumentType other = (PIDInstInstrumentType) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof PIDInstInstrumentType;
    }
