...
public class PIDInstRelatedIdentifier {
    ...
    public void setType(PIDInstRelatedIdentifierType type) {
        this.type = type;
    }

    public PIDInstRelatedIdentifierType getType() {
        return this.type;
    }

    public void setRelation(PIDInstRelationType relation) {
        this.relation = relation;
    }

    public PIDInstRelationType getRelation() {
    ...
    public String toString() {
        ...
        Object o;
        sb.append("PIDInstRelatedIdentifier(");
    ...
    public boolean equals(final Object o) {
        ...
        if ( !(o instanceof PIDInstRelatedIdentifier) ) return false;
        final PIDInstRelatedIdentifier other = (PIDInstRelatedIdentifier) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof PIDInstRelatedIdentifier;
    }
