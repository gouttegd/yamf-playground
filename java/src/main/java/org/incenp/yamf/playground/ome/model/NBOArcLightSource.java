...
@LinkURI("https://exanple.org/ome-nbo/NBOArcLightSource")
public class NBOArcLightSource extends ArcLightSource {
    ...
    public String toString() {
        return "NBOArcLightSource(id=" + this.getId() + ")";
    }

    @Override
    public boolean equals(final Object o) {
        if ( o == this ) return true;
        if ( !(o instanceof NBOArcLightSource) ) return false;
        final NBOArcLightSource other = (NBOArcLightSource) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof NBOArcLightSource;
    }
