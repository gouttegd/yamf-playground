...
@LinkURI("https://exanple.org/ome-nbo/NBOLightSource")
public class NBOLightSource extends LightSource {
    ...
    public String toString() {
        return "NBOLightSource(id=" + this.getId() + ")";
    }

    @Override
    public boolean equals(final Object o) {
        if ( o == this ) return true;
        if ( !(o instanceof NBOLightSource) ) return false;
        final NBOLightSource other = (NBOLightSource) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof NBOLightSource;
    }
