...
@LinkURI("https://example.invalid/pidinst/PIDInstMeasuredQuantity")
public class PIDInstMeasuredQuantity {
    ...
    public String toString() {
        ...
        Object o;
        sb.append("PIDInstMeasuredQuantity(");
    ...
    public boolean equals(final Object o) {
        ...
        if ( !(o instanceof PIDInstMeasuredQuantity) ) return false;
        final PIDInstMeasuredQuantity other = (PIDInstMeasuredQuantity) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof PIDInstMeasuredQuantity;
    }
