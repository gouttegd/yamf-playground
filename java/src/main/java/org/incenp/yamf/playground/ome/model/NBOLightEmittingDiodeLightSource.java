...
@LinkURI("https://exanple.org/ome-nbo/NBOLightEmittingDiodeLightSource")
public class NBOLightEmittingDiodeLightSource extends LightEmittingDiodeLightSource {
    ...
    public String toString() {
        return "NBOLightEmittingDiodeLightSource(id=" + this.getId() + ")";
    }

    @Override
    public boolean equals(final Object o) {
        if ( o == this ) return true;
        if ( !(o instanceof NBOLightEmittingDiodeLightSource) ) return false;
        final NBOLightEmittingDiodeLightSource other = (NBOLightEmittingDiodeLightSource) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof NBOLightEmittingDiodeLightSource;
    }
