...
from incenp.yamf.playground.direct import read_base, read_foo, get_foo
...
class TestDirect(unittest.TestCase):
    ...
    def test_base_impl(self):
        ...
        ins = read_base("../samples/pidinst/pidinst-extended-direct.json")
    ...
    def test_foo_impl(self):
        ...
        ins = read_foo("../samples/pidinst/pidinst-extended-direct.json")
        self.assertEqual("The Model Name", ins.model.name)
