...
linkml_meta = LinkMLMeta({'default_prefix': 'https://example.org/bar/',
     'default_range': 'string',
     'id': 'https://example.org/bar',
     'imports': ['base'],
     'name': 'pidinst-bar-extension',
     'prefixes': {'fooext': {'prefix_prefix': 'fooext',
                             'prefix_reference': 'https://example.org/bar/'}},
     'source_file': '../../../../../linkml/bar.yaml'} )
