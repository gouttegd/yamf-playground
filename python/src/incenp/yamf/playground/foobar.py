...
linkml_meta = LinkMLMeta({'default_prefix': 'https://example.net/foobar/',
     'default_range': 'string',
     'id': 'https://example.net/foobar',
     'imports': ['foo', 'bar'],
     'name': 'pidinst-foobar-extension',
     'prefixes': {'foobarext': {'prefix_prefix': 'foobarext',
                                'prefix_reference': 'https://example.net/foobar/'}},
     'source_file': '../../../../../linkml/foobar.yaml'} )
...
class FooMixin(ConfiguredBaseModel):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://example.com/foo'})
...
class Foo(ConfiguredBaseModel):
    ...
    fooName: str = Field(default=..., json_schema_extra = { "linkml_meta": {'domain_of': ['Foo']} })
    fooType: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['Foo']} })


class FooInstrument(FooMixin, Instrument):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://example.com/foo', 'mixins': ['FooMixin']})
...
class BarMixin(ConfiguredBaseModel):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://example.org/bar'})

    bar: Optional[Bar] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['BarMixin']} })


class Bar(ConfiguredBaseModel):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://example.org/bar'})

    barName: str = Field(default=..., json_schema_extra = { "linkml_meta": {'domain_of': ['Bar']} })
    barType: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['Bar']} })


class BarInstrument(BarMixin, Instrument):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://example.org/bar', 'mixins': ['BarMixin']})
...
class FooBarInstrument(BarMixin, FooMixin, Instrument):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://example.net/foobar',
...
BarMixin.model_rebuild()
Bar.model_rebuild()
BarInstrument.model_rebuild()
FooBarInstrument.model_rebuild()
