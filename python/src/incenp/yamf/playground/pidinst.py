...
class Date(ConfiguredBaseModel):
    ...
    type: DateType = Field(default=..., json_schema_extra = { "linkml_meta": {'domain_of': ['Date', 'RelatedIdentifier', 'AlternateIdentifier']} })
...
class RelatedIdentifier(ConfiguredBaseModel):
    ...
    name: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['IsIdentifiableEntity',
                       'RelatedIdentifier',
                       'AlternateIdentifier']} })
    type: RelatedIdentifierType = Field(default=..., json_schema_extra = { "linkml_meta": {'domain_of': ['Date', 'RelatedIdentifier', 'AlternateIdentifier']} })
...
class AlternateIdentifier(ConfiguredBaseModel):
    ...
    identifier: str = Field(default=..., json_schema_extra = { "linkml_meta": {'domain_of': ['IsIdentifiableEntity',
                       'RelatedIdentifier',
                       'AlternateIdentifier']} })
    type: AlternateIdentifierType = Field(default=..., json_schema_extra = { "linkml_meta": {'domain_of': ['Date', 'RelatedIdentifier', 'AlternateIdentifier']} })
    name: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['IsIdentifiableEntity',
                       'RelatedIdentifier',
                       'AlternateIdentifier']} })
